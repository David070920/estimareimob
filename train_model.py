...
def main():
    ...
    X = df[['usable_area_sqm', 'build_year', 'floor', 'total_rooms']].copy()
    y = df['asking_price_eur']

    # Impute missing values for build_year, floor, total_rooms with median
    ...
    # Model Serialization
    model_filename = 'xgboost_pricing_model.joblib'
